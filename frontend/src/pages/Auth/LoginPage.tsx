          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-purple-400 border-2 border-purple-200 rounded focus:ring-purple-400 focus:ring-2"
                />
                <span className="text-slate-600 font-poppins">Remember me</span>
              </label>
              <Link
                to="/forgot-password"
                className="text-purple-600 hover:text-purple-700 font-poppins font-medium transition-colors duration-200"
              >
                Forgot password?
              </Link>
            </div>
